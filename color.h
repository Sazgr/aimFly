...
const Color GRAY_4_COLOR_100 = hexToColor("#B9C9C7", 1.0f);
const Color GRAY_4_COLOR_80 = hexToColor("#B9C9C7", 0.8f);

const Color GRAY_5_COLOR_100 = hexToColor("#E4F4F4", 1.0f);
const Color GRAY_5_COLOR_80 = hexToColor("#E4F4F4", 0.8f);
const Color GRAY_5_COLOR_40 = hexToColor("#E4F4F4", 0.4f);
